    ...
    return (
        <div className="relative flex flex-col items-center justify-center w-full py-20">
            <Container className="py-20 max-w-6xl mx-auto">
                <div className="relative flex flex-col items-center justify-center py-12 lg:py-20 px-0 rounded-2xl lg:rounded-3xl bg-black text-center border border-[#08fefe]/20 overflow-hidden">
                    <Particles
                        refresh
                        ease={80}
                        quantity={80}
                    ...
                    <motion.div
                        ...
                        style={{
                            background: 'conic-gradient(from 0deg at 50% 50%, #a855f7 0deg, #3b82f6 180deg, #ff0000 360deg)',
                        }}
                        animate={{
                            rotate: 360
                        }}
