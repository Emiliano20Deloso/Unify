        ...
        <div className="relative flex flex-col items-center justify-center max-w-5xl py-20 mx-auto">
            <Container>
                <div className="flex flex-col items-center justify-center w-full max-w-3xl mx-auto text-center">
                    <h2 className="text-2xl gl:text-4xl lg:text-5xl font-heading font-medium !leading-snug mb-6 text-white">
                        Instantly translate your content into 60+ <span className="font-subheading italic text-[#08fefe]">languages</span>
                    </h2>
                </div>
            </Container>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 items-start justify-start max-w-4xl mx-auto pt-10 relative w-full">
                ...
                <div className="absolute top-1/2 -translate-y-1/2 right-1/4 w-3/5 h-14 lg:h-20 bg-gradient-to-r from-[#d39d5d] to-[#c88f4f] rounded-full -rotate-12 blur-[10rem] -z-10"></div>
